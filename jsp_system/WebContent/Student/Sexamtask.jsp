				...
				<div class="container">
  					...
  					<table class="total-table">
					    ...
					    <%
							...
							ArrayList<Map<String, String>> f = dao.queryStuTask(username);
							int i=0;
							for (Map<String, String> task : f) {	
						%>
					        <tr>
					            <td><%=task.get("course_name") %></td>
					            <td><%=task.get("user_name") %></td>
					            <td><%=task.get("class_name") %></td>
					            <td><%=task.get("begin_time") %></td>
					            <td><a href="${pageContext.request.contextPath}/Student/Sexamquestion.jsp">进入考试</a></td>
					        </tr>
					    <%
							}
						%>		
