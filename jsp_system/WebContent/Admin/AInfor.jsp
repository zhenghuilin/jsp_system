		  					...
		  					<div class="col-md-6">
			  					<div class="layui-form-item">
								    ...
								    <div class="layui-input-block">
								      	<input type="text" name="old_password" lay-verify="title" autocomplete="off" placeholder="请输入旧密码" class="layui-input">
								    </div>
								</div>
								<div class="layui-form-item">
								    <label class="layui-form-label">新密码</label>
								    <div class="layui-input-block">
								      	<input type="text" name="new_password" lay-verify="title" autocomplete="off" placeholder="请输入新密码" class="layui-input">
								    </div>
								</div>
								<div class="layui-form-item">
								    <label class="layui-form-label">新密码</label>
								    <div class="layui-input-block">
								      	<input type="text" name="new_password2" lay-verify="title" autocomplete="off" placeholder="请再次输入新密码" class="layui-input">
								    </div>
								</div>
								<div class="layui-form-item">
								    <div class="layui-input-block">
