					...
					<table class="total-table">
					    ...
					    <tbody>
					       <%
								...
								ArrayList<Map<String, String>> files = dao.queryNoCheckUser();
								int i=0;
					        ...
					        <tr>
					            ...
					            <td>
						            <a href="${pageContext.request.contextPath}/AQTypeUpdate?question_type_id=<%=file.get("question_type_id")%>">审核通过 </a>
