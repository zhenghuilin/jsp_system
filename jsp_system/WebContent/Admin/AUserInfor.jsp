		...
		<div class="flypanels-main">
			...
			<!-- <div class="row"> -->				
				<div class="container">
					...
					<div class="row">
						<div class="col-md-10">
							<p style="font-size:18px;margin-top:10px;">单用户导入</p>
						</div>
						<div class="col-md-1">
							<button class="layui-btn layui-btn-primary" style="margin-left:70px;">批量导入</button>
						</div>
					...
					<form class="bs-example bs-example-form" role="form" action="${pageContext.request.contextPath}/AddQType" method="post">
						<div class="input-group" style="margin-top:30px;">
							...
							<input type="text" name="question_type_name" class="form-control" placeholder="请输入需要添加用户名">
						</div>
						<div class="input-group" style="margin-top:30px;">
							<span class="input-group-addon">密码</span>
							<input type="password" name="question_type_name" class="form-control" placeholder="请输入需要添加用户的密码">
						</div>
  					...
  					<table class="total-table">
					    ...
					    <tbody>
					     	<%
								...
								ArrayList<Map<String, String>> files = dao.queryUserAll();
								int i=0;
								for (Map<String, String> file : files) {	
							%>
					        <tr>
					            <td><%=file.get("user_id")%></td>
					            <td><%=file.get("user_name")%></td>
					            <td><%=file.get("password")%></td>
					            <td><%=file.get("character_name")%></td>
								<td><a href="AQTypeWatch.jsp?question_type_id=<%=file.get("question_type_id")%>">查看</a>
