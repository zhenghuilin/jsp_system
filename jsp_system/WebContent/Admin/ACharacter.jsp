		...
		<div class="flypanels-main">
			...
			<!-- <div class="row"> -->				
				<div class="container">
  					...
  					<table class="total-table">
					    ...
					    <tbody>
					     	<%
								...
								ArrayList<Map<String, String>> files = dao.queryCharacterAll();
								int i=0;
								for (Map<String, String> file : files) {	
							%>
					        <tr>
					            <td><%=file.get("character")%></td>
					...
					<form class="bs-example bs-example-form" role="form" action="AddCharacter" method="post">
						<div class="input-group" style="margin-top:30px;">
							<span class="input-group-addon">角色名称</span>
							<input type="text" name="character_name" class="form-control" placeholder="请输入需要添加的角色名称">
						</div>
