				...
				<div class="container">
					...
					<div class="row courses">
  						<%
							...
							ArrayList<Map<String, String>> files = dao.queryTcourse(user_name);
							int i=0;
				
							for (Map<String, String> file : files) {	
						%>
						<div class="col-md-3">
							<a href="#" alt=""><img src="${pageContext.request.contextPath}/images/course_img.jpg"></a><br>
							<p class="course_name"><a href="#" alt=""><%=file.get("course_name") %></a></p>
							<p class="course_id">课程编号：<%=file.get("course_id") %></p>
							<p class="course_teacher">课程信息：<%=file.get("course_infor") %></p>
						</div>
						<%
							}
						%>
					...
					<!--底部内容 -->
					<div class="content-bottombar" style="margin-top:180px;">
						<!-- <div class="row"> -->
