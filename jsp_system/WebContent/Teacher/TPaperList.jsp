		...
		<div class="flypanels-main">
			...
			<!-- <div class="row"> -->				
				<div class="container">
					...
					<table class="total-table">
					    ...
					    <tbody>
					     <%
							...
							ArrayList<Map<String, String>> f = dao.queryPaperList(username);
							int i=0;
						...
						%>
					        <tr>
					            ...
					            <td><%=score.get("create_time") %></td>
					            <td><%=score.get("paper_status") %></td>
					            <td><a href="#">查看 </a>
					            <a href="#"> 修改 </a>
					            <a href="#"> 删除</a></td>
					        </tr>
					...
					<!--底部内容 -->
					<div class="content-bottombar" style="margin-top:380px;">
						<!-- <div class="row"> -->
