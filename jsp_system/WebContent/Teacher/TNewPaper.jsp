			...
			<!-- <div class="row"> -->				
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-8">
							<input type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入试卷名称" class="layui-input">
						</div>
					...
					<div class="row">
						<div class="col-md-2"></div>
						<div class="col-md-2">
							<button type="reset" class="layui-btn layui-btn-primary">确认新建</button>
						</div>
						<div class="col-md-8"></div>
					</div>

					<!--底部内容 -->
					<div class="content-bottombar" style="margin-top:480px;">
						<!-- <div class="row"> -->
