		...
		<div class="flypanels-main">
			...
			<!-- <div class="row"> -->				
				<div class="container">
					...
					<div class="row">
						<div class="col-md-2">
							<label class="layui-form-label" style="width:100%;">题库名称</label>
						</div>
						<div class="col-md-8">
							<input type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入维护的题库名称" class="layui-input">
						</div>
